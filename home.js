...
// Slide In 4 Animation
var slideIn4 = anime.timeline({
    loop: false,
    autoplay: false,
});
...
$('#hp-3').on('inview', function (event, isInView) {
    if (isInView) {
        // Put the play below this line
        slideIn2.play();
    } else {
...
// Play animation when scrolled into view
$('#hp-intro').on('inview', function (event, isInView) {
    if (isInView) {
        // Put the play below this line
        slideIn.play();
    } else {
...
// Play animation when scrolled into view
$('#hp-4').on('inview', function (event, isInView) {
    if (isInView) {
        // Put the play below this line
        slideIn3.play();
    } else {
...
// Play animation when scrolled into view
$('#hp-6').on('inview', function (event, isInView) {
    if (isInView) {
        // Put the play below this line
        slideIn4.play();
    } else {
